...
router.get('/manageguestbook/delete/:postId', function(request,response){
...
router.get("/manageportfolio/delete/:projectId", function (request, response) {
...
router.get('/manageblog/delete/:blogId', function(request,response){
    const blogId = request.params.blogId
